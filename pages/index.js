...
export async function getServerSideProps({ query }) {
  try {
    ...
    return {
      props: {
        products: res.products || [], // Set an empty array if `res.products` is undefined
        result: res.result || 0, // Set 0 if `res.result` is undefined
      },
    };
  } catch (error) {
    ...
    return {
      props: {
        ...
        result: 0, // Set the result to 0 if there's an error
      },
    };
  }
}
